...
```
> curl -XPOST -H "Content-Type: application/json" localhost:9000/lunaconf.MyServiceEntity/GetValue -d '{"entityId": "foo"}'
...
```shell
> grpcurl -plaintext -d '{"entityId": "foo"}' localhost:9000 lunaconf.MyServiceEntity/GetValue
ERROR:
  Code: Unknown
